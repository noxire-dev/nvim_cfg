...
Use this repo directly so you can keep your changes and deploy easily.
...
> [!NOTE]
> If you fork this repo later, replace the URL below with your fork URL.

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/noxire-dev/nvim_cfg.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/noxire-dev/nvim_cfg.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/noxire-dev/nvim_cfg.git "${env:LOCALAPPDATA}\nvim"
```
